...
export const generateExcelFromDatabase = async () => {
  try {
    console.log('🔄 Generating Excel from REAL database...');
    ...
    vacations.forEach(vacation => {
      ...
      vacationSheet.addRow({
        employee: vacation.employees?.name || employee?.name || vacation.employee_id,
    ...
    console.log('✅ Excel export from REAL database completed successfully');
    return true;
  } catch (error) {
